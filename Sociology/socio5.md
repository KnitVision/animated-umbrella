---
title: Origins of Sociology - Modernity, Industrialization, and Conflict Theory
course: Sociology
tags:
  - sociology
  - epistemology
...
- Which forms of knowledge are considered valuable or authoritative?
- What methods allow a claim to count as knowledge?
...
| Process | Approximate period | Sociological significance |
|---|---:|---|
| Renaissance | 14th-17th centuries | Renewed art, inquiry, humanism, and attempts to represent the world beyond inherited scriptural accounts |
| Protestant Reformation | 16th century | Challenged the authority and institutional monopoly of the Catholic Church |
| Scientific Revolution | 16th-17th centuries | Strengthened observation, experiment, and mathematical explanation of the physical world |
| European colonial expansion | From the 15th century | Transferred resources and wealth to Europe and created unequal global economic relations |
| Industrial Revolution | Mainly late 18th-19th centuries | Mechanized production, weakened feudal relations, expanded capitalism, and accelerated urbanization |
| Political revolutions | 18th-19th centuries | Popularized liberty, equality, citizenship, and challenges to inherited authority |
...
- The **monarch** administered the material world: land, labor, wealth, law, and political order.
- The **church** claimed authority over spiritual welfare, morality, sin, salvation, and the path to heaven.
...
The sociological point is not simply theological. It concerns the relationship among:

- Moral authority
- Institutional power
- Wealth and class privilege
- Accountability
- Control over legitimate knowledge
...
The establishment of the **Church of England**, for example, represented both a religious break and a struggle over whether an authority in Rome could govern the English monarch and population.

The Reformation therefore involved:

- Protest against centralized church authority
- Competition between religious and political institutions
- New approaches to scripture and faith
...
**Scientific temper** refers to a disposition toward:

- Observation
- Evidence
- Experimentation
- Doubt and revision
- Natural rather than exclusively supernatural explanation
...
This represented a broader epistemic shift:

```text
Truth authorized mainly by scripture
                ↓
Truth also investigated through observation, representation, and experiment
```
...
Eduardo Galeano's *Open Veins of Latin America* uses the metaphor of a continent whose veins were opened and emptied. The metaphor captures a one-directional flow of resources from colonized regions toward European enrichment.

Colonialism supported industrial capitalism by providing:

- Accumulated wealth for investment
- Raw materials such as minerals and cotton
- Cheap or coerced labor
- Access to land and mines
- Markets for manufactured European goods
- Political control over trade routes and exchange
...
```text
Colonial raw materials and labor
              ↓
European industrial production
              ↓
Colonial and global markets for finished goods
              ↓
...
```text
Ideas ↔ institutions ↔ material resources ↔ conflict ↔ unintended outcomes
```

The Industrial Revolution cannot be assigned a fixed percentage to the Renaissance, Reformation, colonialism, capitalism, or political revolution. It emerged from their changing relationship.

Relevant elements included:

- Renaissance thought and artistic inquiry
- Religious reform
...
- Were tied to the land across generations
- Could not freely move elsewhere
- Passed with the land when control of the estate changed
- Performed agricultural labor
- Surrendered a substantial share of their produce to the lord
- Retained only part for household consumption or limited exchange

Women also performed agricultural, household, and manor labor, though this labor is often obscured in simplified accounts of feudal production.

| Feudal lord | Serf |
|---|---|
| Controlled land and appropriated surplus | Worked land without freedom to leave it |
...
- Broke hereditary attachment to land
- Dissolved some fixed feudal obligations
- Expanded geographical and occupational mobility
- Generalized ideals such as liberty, equality, and fraternity
- Developed productive capacity
- Created conditions from which further demands for freedom could arise
...
```text
Hunter-gatherer / primitive communal society
                    ↓
...
Migration was intensified by:

- Crisis within feudal agriculture
- Population pressures
- Rural poverty and dispossession
- Famines and crop failures
- Demand for factory labor
- The promise of a better life in cities

> [!note] Potato blight
> The transcript associates migration from England with potato blight. Historically, potato blight is most strongly associated with the Great Irish Famine of 1845-1852 and mass Irish death and migration.
...
| Anthropology, historically | Sociology, historically |
|---|---|
| Often studied a community in its local setting | Often studied rapidly changing modern and industrial societies |
| Examined food, ritual, marriage, religion, and dwelling | Examined institutions, mobility, migration, class, and urbanization |
| Frequently represented society as bounded and relatively static | Emphasized movement and transformation |
...
- Serfdom
- Caste hierarchy
- Fixed gender destiny
- Occupations assigned at birth
- Immobility enforced by status

The lecture connects **freedom** to the capacity to move:

- Physical movement: Can a person leave a room, village, estate, or country?
- Occupational movement: Can a person change work?
- Social movement: Can a person change status?
- Intellectual movement: Can a person challenge inherited truth?
- Relational movement: Can a person choose associations and life paths?
...
**Social mobility** means movement between positions within a hierarchy. It may involve income, occupation, education, caste status, or prestige.
...
```text
Brain + heart + lungs + limbs → functioning body

Family + economy + religion + state + education → functioning society
```
...
- Organs cannot choose their function, but people can seek different social roles.
- An organ does not move up the bodily hierarchy, while people pursue social mobility.
- The analogy can portray unequal positions as necessary and fixed.
- It can make conflict appear pathological rather than politically meaningful.
- It may imply that disadvantaged groups exist to serve a social function.
- Replaceability can obscure the dignity and agency of workers.
...
- Society is naturally a competition.
- Winners are inherently fitter.
- Existing elites deserve their position.
...
|---|---|---|
| **Conflict / Marxist** | Class, inequality, exploitation, power, and struggle | Who controls resources, and whose interests does the arrangement serve? |
| **Interactionism** | Meaning produced through everyday interaction | How do people interpret one another and coordinate behavior? |
...
- Treated human hierarchy as a biological fact
- Classified colonized peoples as inferior
- Reduced communities to bodily measurements
...
Limits of the book view include:

- Treating elite texts as descriptions of everyone's life
- Presenting ideals as actual practices
- Overrepresenting literate and dominant groups
...
- Contradictions between rule and conduct
- Variation across caste, class, gender, and region
- Social change and mobility

| Book view asks | Field view asks |
|---|---|
| What do authoritative texts prescribe? | What do people actually do? |
| How is society formally classified? | How are classifications negotiated in daily life? |
| What is the stated ideal? | Where do practice and ideal diverge? |
...
Important early themes included:

- The freedom struggle and nationalism
- Caste
- Family and kinship
- Village studies
...
Later developments expanded the field toward:
...
- Marginalized standpoints previously excluded from dominant accounts
...
Marx's central proposition is often summarized as:
...
|---|---|---|---|
| Feudalism | Feudal lords | Serfs | Control of land and appropriation of agricultural surplus |
| Capitalism | Bourgeoisie / capitalist class | Proletariat / workers | Ownership of productive property and purchase of labor power |
...
- How were they educated and socialized?
- Which aspirations appear possible to them?
- Who controls the resources sustaining their existence?

The basic movement is:

```text
Material and social existence → shapes consciousness, ideas, and aspirations
```
...
- Ideas of respectable work
- Economic security
- Peer culture
- The institution's material environment
...
- Feudal lords accumulated agricultural surplus through control of land.
- Capitalists accumulate profit through ownership and control of production.
- The mechanisms differ, but both create unequal classes with opposed material interests.

Workers seek wages, security, dignity, and greater control over life. Owners seek lower costs, greater output, and profit. This structural opposition produces continuing conflict even without open violence.

Class struggle may appear as:

- Strikes
- Wage disputes
- Protests
- Demands for public accountability
- Conflict over examinations and access
...
|---|---|
| Depend on credible public examinations | Can purchase alternatives or use networks |
| Bear the cost of delays and leaks | Are partly insulated from system failure |
| Demand equal procedural opportunity | Exercise greater control over institutions |
...
- Who decides that war will occur?
- Which classes fight and die?
- Who owns weapons companies and military contractors?
- Who profits from reconstruction and resource access?
- Which groups bear taxation, displacement, and inflation?
- Which geopolitical interests are described as national interests?
...
**Imperialism** refers to the extension of political, military, or economic power beyond a state's borders. In a Marxian analysis, geopolitical conflict may be connected to competition over markets, territory, labor, resources, and capital.
...
A sociological reading can ask:

- Why is masculine pain expressed through self-destruction?
- Why does emotional care fall to women?
- Why is failed love converted into alcoholism rather than communication or change?
- How do caste and class shape the relationship?
- Why has this model of tragic masculinity remained culturally resonant?
...
Challenge to religious authority
              +
Renaissance and scientific inquiry
              +
Colonial extraction and global trade
              +
Industrial capitalism and political revolution
              ↓
Breakdown of feudal relations
              ↓
Migration, urbanization, and social mobility
              ↓
Modernity as a new social condition
              ↓
Need for systematic study of changing society
              ↓
Sociology and its multiple paradigms
              ↓
...
- Presentation and viva follow in the next semester.
- The lecture describes the overall project component as **30%**, with essay and presentation mentioned as approximately **15% each**.
- Students must understand and be able to defend every claim during the viva.
...
15. Indian sociology developed around caste, villages, family, kinship, nationalism, mobility, and later Dalit, feminist, and intersectional perspectives.
16. Marx rejects a fixed human nature and argues that material and social conditions shape consciousness and aspirations.
17. Class struggle arises from opposed relationships to land, productive property, labor, surplus, and profit.
...
- **Reformation:** Sixteenth-century religious and political challenge to Catholic Church authority in Europe.
- **Scientific temper:** Commitment to observation, evidence, doubt, experiment, and revisability.
- **Renaissance:** European cultural and intellectual movement associated with renewed art, humanism, inquiry, and representation.
- **Colonialism:** Direct political and economic control of one territory and population by another power.
- **Imperialism:** Broader extension of political, economic, or military power beyond national borders.
- **Industrial Revolution:** Transformation toward mechanized production, factories, fossil-fuel energy, wage labor, and industrial capitalism.
- **Dialectics:** Analysis of change through contradiction, interaction, feedback, and historically developing relationships.
- **Feudalism:** Agrarian social order organized around landholding, lordship, customary obligation, and dependent labor.
- **Manor:** Estate forming the economic and administrative center of feudal life.
- **Serf:** Dependent agricultural laborer tied to a lord's land under feudal relations.
- **Capitalism:** System based on private control of productive property, commodity production, wage labor, and profit accumulation.
- **Modernity:** Social condition associated with industrialization, rationalization, mobility, urbanization, and challenges to inherited authority.
- **Social mobility:** Movement between social positions or levels of a hierarchy.
- **Geographical mobility:** Movement between physical locations.
- **Sanskritization:** Process through which a lower-status caste adopts practices associated with higher or dominant castes to seek status mobility.
- **Functionalism:** Paradigm that studies how interdependent institutions contribute to social order and continuity.
- **Organic analogy:** Comparison of society's institutions to the organs of a living body.
- **Social Darwinism:** Ideological application of simplified evolutionary competition to justify social hierarchy and inequality.
- **Paradigm:** Coherent theoretical perspective with characteristic concepts, questions, assumptions, and methods.
- **Interactionism:** Paradigm studying how meaning and social order arise through interaction.
- **Interpretive sociology:** Approach associated with Weber that explains social action through actors' subjective meanings.
- **Anthropometry:** Measurement of human bodies, historically misused by racial classification systems.
- **Book view:** Understanding society through texts, scriptures, laws, and formal traditions.
- **Field view:** Understanding society through observation and engagement with lived social practice.
- **Conflict theory:** Perspective emphasizing inequality, domination, competing interests, and struggle over resources.
- **Bourgeoisie:** Capitalist class owning or controlling the means of production.
- **Proletariat:** Wage-working class dependent on selling labor power.
- **Means of production:** Resources used to produce goods, including land, factories, machinery, and infrastructure.
- **Historical materialism:** Approach explaining social change through material production, class relations, and contradiction.
...
3. How did the Reformation challenge both religious and political authority?
4. What epistemic shift did Renaissance art, anatomy, and scientific temper represent?
5. Why were colonial extraction and global markets essential to industrialization?
6. How does dialectical causation differ from linear causation?
7. How were serfs positioned within a feudal estate?
8. In what sense did Marx consider capitalism progressive relative to feudalism?
9. Why did migration and urbanization create a new object of study for sociology?
10. How are modernity, freedom, and mobility connected?
...
18. What are the strengths and limits of the book view and field view?
19. Which themes shaped the early development of sociology in India?
20. Why does Marx reject explanations based on a permanent human nature?
21. What does it mean to say that material conditions shape consciousness?
22. How do bourgeoisie and proletariat differ in their relationship to production?
23. How can a public examination protest be interpreted as class struggle?
24. What questions does conflict theory ask about war?
25. How do imperialism and the military-industrial complex connect war to material interests?
